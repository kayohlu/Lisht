...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self.swipeContentView setBackgroundColor:[UIColor whiteColor]];
        [self.contentView addSubview:self.swipeContentView];
        
        // Adding color to the content view to make the layers distinguishable.
        [self.contentView setBackgroundColor:[UIColor colorWithRed:122.0/255.0 green:223.0/255.0 blue:187.0/255.0 alpha:1.0]];
        ...
        self.textField = [[UITextField alloc] initWithFrame: CGRectMake(16, self.swipeContentView.frame.origin.y, self.swipeContentView.frame.size.width, self.swipeContentView.frame.size.height)];
